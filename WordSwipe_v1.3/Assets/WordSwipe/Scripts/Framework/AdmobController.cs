...
public class AdmobController : MonoBehaviour
{
    ...
    private float lastTime = int.MinValue;

    public void ShowInterstitial()
    {
        if (Time.time - lastTime < intersitialAdPeriod) return;
        if (GameManager.Instance.IsAdRemoved()) return;
